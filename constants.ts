...
export const INITIAL_EXPENSES: Expense[] = [
  ...
  {
    id: uuidv4(), date: "2025-04-10", month: "Apr", year: 2025, categoryId: rentCatId,
    provider: "Landlord", description: "Loyer 3 mois (lkra)", amount: 12000, currency: Currency.EUR,
    paymentStatus: PaymentStatus.PAID, paidByPartnerId: zakariaPartnerId, isFixedCharge: false, entryTimestamp: Date.now()
  },
  {
    id: uuidv4(), date: "2025-04-11", month: "Apr", year: 2025, categoryId: officeSuppliesCatId,
    provider: "Retail Store", description: "TV Purchase", amount: 7500, currency: Currency.EUR,
    paymentStatus: PaymentStatus.PAID, paidByPartnerId: zakariaPartnerId, isFixedCharge: false, entryTimestamp: Date.now()
  },
  {
    id: uuidv4(), date: "2025-04-12", month: "Apr", year: 2025, categoryId: softwareSubCatId,
    provider: "Telaja Services", description: "Telaja Service", amount: 1500, currency: Currency.EUR,
    paymentStatus: PaymentStatus.PAID, paidByPartnerId: naoufalPartnerId, isFixedCharge: false, entryTimestamp: Date.now()
  },
  {
    id: uuidv4(), date: "2025-04-13", month: "Apr", year: 2025, categoryId: softwareSubCatId,
    provider: "Rwaq Solutions", description: "Rwaq Service", amount: 1200, currency: Currency.EUR,
    paymentStatus: PaymentStatus.PAID, paidByPartnerId: zakariaPartnerId, isFixedCharge: false, entryTimestamp: Date.now()
  },
  {
    id: uuidv4(), date: "2025-04-14", month: "Apr", year: 2025, categoryId: softwareSubCatId, 
  ...
  // April 2025
  {
    id: uuidv4(), date: "2025-04-01", month: "Apr", year: 2025, categoryId: rentCatId,
    provider: "Landlord", description: "Loyer (Monthly Rent)", amount: 4000, currency: Currency.MAD,
    paymentStatus: PaymentStatus.PAID, paidByPartnerId: unassignedPartnerId, isFixedCharge: true, entryTimestamp: Date.now()
  },
  {
    id: uuidv4(), date: "2025-04-01", month: "Apr", year: 2025, categoryId: internetCatId,
    provider: "Telecom Provider", description: "Connexion Fibre (Monthly)", amount: 500, currency: Currency.MAD,
    paymentStatus: PaymentStatus.PAID, paidByPartnerId: unassignedPartnerId, isFixedCharge: true, entryTimestamp: Date.now()
  },
  {
    id: uuidv4(), date: "2025-04-01", month: "Apr", year: 2025, categoryId: utilitiesCatId,
    provider: "Utility Company", description: "Eau et Electricité (Monthly)", amount: 300, currency: Currency.MAD,
    paymentStatus: PaymentStatus.PAID, paidByPartnerId: unassignedPartnerId, isFixedCharge: true, entryTimestamp: Date.now()
  },
  // May 2025
  {
    id: uuidv4(), date: "2025-05-01", month: "May", year: 2025, categoryId: rentCatId,
    provider: "Landlord", description: "Loyer (Monthly Rent)", amount: 4000, currency: Currency.MAD,
    paymentStatus: PaymentStatus.PAID, paidByPartnerId: unassignedPartnerId, isFixedCharge: true, entryTimestamp: Date.now()
  },
  {
    id: uuidv4(), date: "2025-05-01", month: "May", year: 2025, categoryId: internetCatId,
    provider: "Telecom Provider", description: "Connexion Fibre (Monthly)", amount: 500, currency: Currency.MAD,
    paymentStatus: PaymentStatus.PAID, paidByPartnerId: unassignedPartnerId, isFixedCharge: true, entryTimestamp: Date.now()
  },
  {
    id: uuidv4(), date: "2025-05-01", month: "May", year: 2025, categoryId: utilitiesCatId,
    provider: "Utility Company", description: "Eau et Electricité (Monthly)", amount: 300, currency: Currency.MAD,
    paymentStatus: PaymentStatus.PAID, paidByPartnerId: unassignedPartnerId, isFixedCharge: true, entryTimestamp: Date.now()
  },
  ...
  {
    id: uuidv4(), date: "2025-04-05", month: "Apr", year: 2025, categoryId: serversHostingCatId,
    provider: "Server Provider Intl.", description: "Server Master (USD Plan)", amount: 450, currency: Currency.USD,
    paymentStatus: PaymentStatus.PAID, paidByPartnerId: naoufalPartnerId, isFixedCharge: true, entryTimestamp: Date.now()
  },
  {
    id: uuidv4(), date: "2025-05-05", month: "May", year: 2025, categoryId: serversHostingCatId,
    provider: "Server Provider Intl.", description: "Server Master (USD Plan)", amount: 450, currency: Currency.USD,
    paymentStatus: PaymentStatus.PAID, paidByPartnerId: naoufalPartnerId, isFixedCharge: true, entryTimestamp: Date.now()
  },
  ...
  {
    id: uuidv4(), date: "2025-04-15", month: "Apr", year: 2025, categoryId: serversHostingCatId,
    provider: "logicweb.com", description: "2 servers", itemCount: 2, amount: 200, currency: Currency.USD,
    paymentStatus: PaymentStatus.PAID, paidByPartnerId: zakariaPartnerId, isFixedCharge: true, entryTimestamp: Date.now()
  },
  {
    id: uuidv4(), date: "2025-04-15", month: "Apr", year: 2025, categoryId: serversHostingCatId,
  ...
  {
    id: uuidv4(), date: "2025-04-15", month: "Apr", year: 2025, categoryId: softwareSubCatId,
  ...
  {
    id: uuidv4(), date: "2025-04-15", month: "Apr", year: 2025, categoryId: domainNamesCatId,
    provider: "domaines", description: "Domain Purchase(s) April", itemCount: 0, amount: 500, currency: Currency.USD,
    paymentStatus: PaymentStatus.PAID, paidByPartnerId: naoufalPartnerId, isFixedCharge: true, entryTimestamp: Date.now() // Assuming domains are renewed/billed regularly
  },
  {
    id: uuidv4(), date: "2025-04-15", month: "Apr", year: 2025, categoryId: softwareSubCatId,
  ...
  {
    id: uuidv4(), date: "2025-04-15", month: "Apr", year: 2025, categoryId: miscellaneousCatId, // Could be 'Financial Services' if category exists
    provider: "binance", description: "Binance fees/service", amount: 1170, currency: Currency.USD,
    paymentStatus: PaymentStatus.PAID, paidByPartnerId: naoufalPartnerId, isFixedCharge: false, entryTimestamp: Date.now() // Fees are often variable/one-off
  },
   {
    id: uuidv4(), date: "2025-04-15", month: "Apr", year: 2025, categoryId: serversHostingCatId,
  ...
  { // "montant" entry for Hamza - this is a one-off contribution
    id: uuidv4(), date: "2025-04-20", month: "Apr", year: 2025, categoryId: operationalCostsCatId, // Or a "Partner Contribution" category
    provider: "Internal Funding", description: "General Contribution (Hamza)", amount: 13000, currency: Currency.USD,
    paymentStatus: PaymentStatus.PAID, paidByPartnerId: hamzaPartnerId, isFixedCharge: false, paymentMethod: "Partner Personal", entryTimestamp: Date.now()
  },

  // Data from Image 3 & 4 (May 2025, USD)
  {
    id: uuidv4(), date: "2025-05-15", month: "May", year: 2025, categoryId: domainNamesCatId,
    provider: "domaines", description: "Domaines (Mai)", amount: 200, currency: Currency.USD,
    paymentStatus: PaymentStatus.PAID, paidByPartnerId: naoufalPartnerId, isFixedCharge: true, entryTimestamp: Date.now()
  },
  {
    id: uuidv4(), date: "2025-05-15", month: "May", year: 2025, categoryId: softwareSubCatId,
  ...
  {
    id: uuidv4(), date: "2025-05-15", month: "May", year: 2025, categoryId: serversHostingCatId,
